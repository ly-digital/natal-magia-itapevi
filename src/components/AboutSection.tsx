      ...
      <div className="container mx-auto max-w-5xl relative z-10">
        <div className="flex justify-center mb-4">
          <img 
            ...
            className="estrelas-lua-container max-w-full h-auto"
          />
        </div>
        ...
        <div className="bg-[#006345] backdrop-blur-sm rounded-2xl p-8 md:p-16 border-2 border-[#fbc942]/30 mt-8">
          <div className="space-y-6 text-white leading-relaxed font-gabarito text-lg md:text-xl text-center">
            ...
            <p>
              ...
              a se reunir e celebrar, com arte e cultura, a alegria do Natal — porque - juntos trazemos a magia.
            </p>
            <h3 className="text-2xl md:text-3xl font-bold text-[#fbc942] mt-8 font-effloresce">Participe!</h3>
          </div>
        </div>
      </div>
    </section>
